...
def mccabeint_plotly(comp1, comp2, P=None, T=None, xd=0.9, xb=0.1, xf=0.5, q=0.5, R=2):
...
def update_plot(xd, xb, xf, q, R):
    return mccabeint_plotly(comp1='methanol', comp2='water', T=300, xd=xd, xb=xb, xf=xf, q=q, R=R)
